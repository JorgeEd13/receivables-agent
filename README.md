...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-359%20passing-brightgreen" alt="359 tests">
...
> data** — no proprietary code, no real ledger. Shipped and live: **359 offline tests**, CI
...
```bash
pip install -e ".[dev]"
pytest            # offline: SQL guardrail, RAG, API, MCP, evals, plan-cache, turn-control (359 tests)
```
