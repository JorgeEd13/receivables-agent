...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-346%20passing-brightgreen" alt="346 tests">
...
> data** — no proprietary code, no real ledger. Shipped and live: **346 offline tests**, CI
...
```bash
pip install -e ".[dev]"
pytest            # offline: SQL guardrail, RAG, API, MCP, evals, plan-cache, turn-control (346 tests)
```
