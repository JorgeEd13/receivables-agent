...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-374%20passing-brightgreen" alt="374 tests">
...
> data** — no proprietary code, no real ledger. Shipped and live: **374 offline tests**, CI
...
```bash
pip install -e ".[dev]"
pytest            # offline: SQL guardrail, RAG, API, MCP, evals, plan-cache, turn-control (374 tests)
```
