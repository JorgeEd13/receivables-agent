...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-336%20passing-brightgreen" alt="336 tests">
...
> data** — no proprietary code, no real ledger. Shipped and live: **336 offline tests**, CI
...
```bash
pip install -e ".[dev]"
pytest            # offline: SQL guardrail, RAG, API, MCP, evals, plan-cache, turn-control (336 tests)
```
