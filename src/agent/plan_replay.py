...
scratch* on every hit. Nothing is served from a frozen snapshot:
...
path is ~tens of milliseconds and the number is never stale: the reasoning was
cached, the data is live.
"""
...
from src.agent.plan_cache import Plan
